        ...
        return (
            <Container style={{flex: 1}}>
                        ...
                        >
                            <Text
                                style={{
                                    ...
                                    color: '#000', fontFamily: 'air_bnb_bold',
                                    fontSize: 16
                                }}
                            >Log Vitals</Text>
                        </Button>
                    ...
                    >
                        ...
                        <View style={styles.modalView}>
                            <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                                <Text style={{fontFamily: 'air_bnb_bold', fontSize: 35}}>Log Symptoms</Text>
                                            ...
                                            >
                                                <Card style={{flex: 1, padding: 12, borderRadius: 8}}>
                                                    <CardItem header style={{
                                                        ...
                                                        <Text style={{fontFamily: 'air_bnb_bold', fontSize: 16}}>
                                                            {name}
                                                        </Text>
                                                    </CardItem>
                                                    <CardItem>
                ...
                {this.state.symptomsReport.map(report => {
                    return (
                        <View
                            style={{height: 250, borderTopWidth: 0.5, borderBottomWidth: 0.5, borderColor: '#D3D3D3'}}>
                            <View style={{flex: 1, paddingTop: 20, paddingHorizontal: 60}}>
                                <View>
                                    <Text style={{fontFamily: 'air_bnb_bold'}}>{date}</Text>
                                </View>
                                {/*the first row */}
                                <View style={{flex: 1}}>
                                    <View style={{flex: 1, flexDirection: 'row'}}>
                                        <View style={{
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{fontFamily: 'air_bnb_bold', color: '#fff'}}>Aches</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Aches and Pain"].key}</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Aches and Pain"].value}</Text>
                                            </View>
                                        </View>
                                        <View style={{
                                            flex: 1,
                                            ...
                                            <View style={{justifyContent: 'center', alignItems: 'center', padding: 5}}>
                                                <Text style={{fontFamily: 'air_bnb_bold', color: '#fff'}}>Breath
                                                    Shortness</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Shortness of breath"].key}</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Shortness of breath"].value}</Text>
                                            </View>
                                        </View>
                                        <View style={{
                                            flex: 1,
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{fontFamily: 'air_bnb_bold', color: '#fff'}}>Fever</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Fever"].key}</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Fever"].value}</Text>
                                            </View>
                                        </View>
                                    </View>
                                    {/*end of first row */}
                                    ...
                                    <View style={{flex: 1, flexDirection: 'row'}}>
                                        <View style={{
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{fontFamily: 'air_bnb_bold', color: '#fff'}}>Dry Cough</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["dry cough"].key}</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["dry cough"].value}</Text>
                                            </View>
                                        </View>
                                        <View style={{
                                            flex: 1,
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{fontFamily: 'air_bnb_bold', color: '#fff'}}>Tiredness</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Tiredness"].key}</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Tiredness"].value}</Text>
                                            </View>
                                        </View>
                                        <View style={{
                                            flex: 1,
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={{fontFamily: 'air_bnb_bold', color: '#fff'}}>Sore
                                                    Throat</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Sore Throat"].key}</Text>
                                                <Text style={{
                                                    fontFamily: 'air_bnb_bold',
                                                    color: '#fff'
                                                }}>{report["Sore Throat"].value}</Text>
                                            </View>
                                        </View>
                                    </View>
                                    {/*end of second row */}
