...
const {CountryStats, GlobalStats} = require('../utils/graphql/queries/queries');
...
const SECTIONS = [
    {
        ...
        content: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam placeat praesentium provident, quam quidem rerum sapiente, sint voluptas.  perferendis possimus rem saepe."
    },
    {
        title: "What are the Symptoms of COVID-19?",
        content: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias cupiditate dolorum error id incidunt natus perferendis qui quod rerum tenetur! Aliquam autem consectetur cupiditate dicta doloremque eaque facilis fugiat id, nobis obcaecati officia optio pariatur tempora temporibus ullam voluptates, voluptatibus."
    }, {
        title: "How does COVID-19 Spread?",
        content: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto ea, et excepturi illum omnis quia ratione suscipit! Accusantium, assumenda, perspiciatis."
    },
    {
        title: "What can i do to protect myself and prevent the spread of the diseas",
        content: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam assumenda autem blanditiis dignissimos dolore dolores doloribus eligendi, ex hic, incidunt inventore ipsam minima nemo nihil porro praesentium quod rem similique temporibus ut. Commodi itaque, vitae."
    },
    {
        title: "How likely am i to catch COVID-19?",
        content: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. A blanditiis consequatur doloribus enim est maxime nisi nobis sed vel, voluptatibus?"
    },
    {
    ...
    },
    {
        ...
        content: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto autem consequatur error est facere iusto modi natus, nisi odit officiis optio quisquam, quos tempore, voluptatem."
    },
    {
    ...
    {
        title: "Are there any medications or therapy that can prevent or cure COVID-19?",
        content: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. A blanditiis consequatur doloribus enim est maxime nisi nobis sed vel, voluptatibus?"
    },
    {
        ...
        return (
            <Container style={{flex: 1}}>
                <View style={{height: 50, marginLeft: 20}}>
                    <Text style={{fontFamily: 'air_bnb_bold', fontSize: 30}}>Settings</Text>
                </View>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableOpacity
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            <Text style={{fontFamily: 'air_bnb_bold'}}>Self Assessment</Text>
                            <Text style={{fontFamily: 'air_bnb_light', fontSize: 12, paddingTop: 2}}>Ascertain your
                                covid-19 risk using our screening tool</Text>
                        </View>
                    ...
                    <TouchableOpacity onPress={() => this.setState({showFAQs: true})}
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            <Text style={{fontFamily: 'air_bnb_bold'}}>FAQs</Text>
                            <Text style={{fontFamily: 'air_bnb_light', fontSize: 12, paddingTop: 2}}>Get answers to
                    ...
                    <TouchableOpacity onPress={() => this.setState({showTesting: true})}
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            <Text style={{fontFamily: 'air_bnb_bold'}}>Testing Centers</Text>
                            <Text style={{fontFamily: 'air_bnb_light', fontSize: 12, paddingTop: 2}}>View testing centers
                                near you</Text>
                        </View>
                        <View style={{alignSelf: 'center', paddingRight: 15}}>
                            <Ionicons name="ios-arrow-forward" size={30} color="black"/>
                    ...
                    <TouchableOpacity onPress={() => this.setState({showProfile: true})}
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            <Text style={{fontFamily: 'air_bnb_bold'}}>Personal Details</Text>
                            <Text style={{fontFamily: 'air_bnb_light', fontSize: 12, paddingTop: 2}}>View and update your
                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            <Text style={{fontFamily: 'air_bnb_bold'}}>Statistics</Text>
                            <Text style={{fontFamily: 'air_bnb_light', fontSize: 12, paddingTop: 2}}>Get the current
                                statistics of the COVID-19</Text>
                        </View>
                        <View style={{alignSelf: 'center', paddingRight: 15}}>
                            <Ionicons name="ios-arrow-forward" size={30} color="black"/>
                        </View>
                    ...
                    <TouchableOpacity style={{
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            <Text style={{fontFamily: 'air_bnb_bold'}}>Privacy Policy</Text>
                            <Text style={{fontFamily: 'air_bnb_light', fontSize: 12, paddingTop: 2}}>View our privacy
                                policy</Text>
                        </View>
                        <View style={{alignSelf: 'center', paddingRight: 15}}>
                            <Ionicons name="ios-arrow-forward" size={30} color="black"/>
                    ...
                    <TouchableOpacity onPress={this._shareMessage}
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            <Text style={{fontFamily: 'air_bnb_bold'}}>Share</Text>
                            <Text style={{fontFamily: 'air_bnb_light', fontSize: 12, paddingTop: 2}}>Share this app with
                ...
                >
                    ...
                    <View style={styles.modalView}>
                        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                            <Text style={{fontFamily: 'air_bnb_bold', fontSize: 28, paddingTop: 30}}>Self Assessment</Text>
                        </View>
                        <View style={{marginTop: 30}}>
                            <Text style={{fontFamily: 'air_bnb_bold', paddingBottom: 4}}>Getting Started!</Text>
                            <Text style={{
                                fontFamily: 'air_bnb_regular',
                                fontSize: 14,
                                textAlign: 'justify',
                                paddingBottom: 4
                            }}>This tool is intended to help you understand what to do next about COVID-19.You'll answer
                                a few questions about your symptoms,travel and contact you've had with others.</Text>
                            <Text style={{fontFamily: 'air_bnb_bold', paddingBottom: 4}}>Note</Text>
                            <Text style={{
                                fontFamily: 'air_bnb_regular',
                                fontSize: 14,
                                textAlign: 'justify',
                                ...
                                used to diagnose or treat medical conditions.</Text>
                            <Text style={{
                                fontFamily: 'air_bnb_regular',
                                fontSize: 14,
                                textAlign: 'justify',
                                paddingBottom: 4
                            }}>Let's all look out for each other by knowing our status, trying not to infect others, and
                                reserving care for those in need</Text>
                        </View>
                ...
                >
                    <View style={styles.modalView}>
                        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                            <Text style={{fontFamily: 'air_bnb_bold', fontSize: 28}}>FAQs</Text>
                ...
                >
                    ...
                    <View style={styles.modalView}>
                        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                            <Text style={{fontFamily: 'air_bnb_bold', fontSize: 28}}>Testing Centers</Text>
                            <Ionicons name="md-close" size={30} color="black"
                        ...
                        <View
                            ...
                            <View style={{marginRight: 30}}>
                                <Text style={{marginBottom: 20, fontFamily: 'air_bnb_bold', fontSize: 12}}>ani-fori medical
                                    institute</Text>
                ...
                >
                    <View style={styles.modalView}>
                        <View style={{paddingTop: 30, paddingBottom: 10, margin: 0, borderBottomWidth: 2}}>
                            <Text style={{fontFamily: 'air_bnb_bold', fontSize: 28}}>COVID-19</Text>
                            <Text style={{fontFamily: 'air_bnb_bold', fontSize: 28}}>Worldwide</Text>
                        </View>
                        ...
                        <View style={{paddingTop: 20, flex: 1}}>
                            ...
                            <Card style={{borderRadius: 10}}>
                                ...
                                <CardItem>
                                    ...
                                    <View style={{borderEndWidth: 0.5, paddingRight: 30}}>
                                        ...
                                        <Text style={{fontFamily: 'air_bnb_bold'}}>{this.state.globalStats.cases}</Text>
                                    </View>
                                    <View style={{borderEndWidth: 0.5, paddingRight: 30, paddingLeft: 5}}>
                                        <Text style={{color: 'green'}}>Recovered</Text>
                                        <Text
                                            style={{fontFamily: 'air_bnb_bold'}}>{this.state.globalStats.recovered}</Text>
                                    </View>
                                    <View style={{paddingLeft: 5}}>
                                        <Text style={{color: 'red'}}>Deaths</Text>
                                        <Text style={{fontFamily: 'air_bnb_bold'}}>{this.state.globalStats.deaths}</Text>
                                    </View>
                                    </Body>
                                </CardItem>
                            </Card>
                            {/*Country Picker */}
                            <View style={{paddingTop: 20}}>
                                <Text style={{fontFamily: 'air_bnb_bold', fontSize: 12, paddingLeft: 5}}>Select
                                    Country:</Text>
                                <Card style={{
                                    borderRadius: 7,
                                    flexDirection: 'row',
                                ...
                                <Card style={{padding: 5}}>
                                    ...
                                    <CardItem>
                                        ...
                                        <View style={{borderEndWidth: 0.5, paddingRight: 30}}>
                                            <Text style={{color: 'blue'}}>Confirmed</Text>
                                            <Text
                                                style={{fontFamily: 'air_bnb_bold'}}>{this.state.countryStats.cases}</Text>
                                            <Text style={{color: 'orange', paddingTop: 20}}>Active</Text>
                                            <Text style={{fontFamily: 'air_bnb_bold'}}>1,384</Text>
                                        </View>
                                        <View style={{borderEndWidth: 0.5, paddingRight: 30, paddingLeft: 5}}>
                                            <Text style={{color: 'green'}}>Recovered</Text>
                                            <Text
                                                style={{fontFamily: 'air_bnb_bold'}}>{this.state.countryStats.recovered}</Text>
                                            <Text style={{color: 'green', paddingTop: 20}}>Critical</Text>
                                            <Text style={{fontFamily: 'air_bnb_bold'}}>4</Text>
                                        </View>
                                        <View style={{paddingLeft: 5}}>
                                            <Text style={{color: 'red'}}>Deaths</Text>
                                            <Text
                                                style={{fontFamily: 'air_bnb_bold'}}>{this.state.countryStats.deaths}</Text>
                                            <Text style={{color: 'red', paddingTop: 20}}>Test</Text>
                                            <Text
                                                style={{fontFamily: 'air_bnb_bold'}}>{this.state.countryStats.test}</Text>
                                        </View>
                                        </Body>
                                    </CardItem>
                                </Card>
                            ...
                            <View style={{flexDirection: 'row-reverse', flex: 1}}>
                                <Text style={{fontFamily: 'air_bnb_regular', fontSize: 12}}>{date}</Text>
                                <Text style={{fontFamily: 'air_bnb_bold', fontSize: 12}}>Last Updated:</Text>
                            </View>
                        </View>
                    </View>
                </Modal>
