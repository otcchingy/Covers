                ...
                <ScrollView>
                    ...
                    <TouchableOpacity
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            ...
                            <Text style={{fontFamily: 'rale_light', fontSize: 12, paddingTop: 2}}>Ascertain your
                    ...
                    <TouchableOpacity onPress={() => this.setState({showFAQs: true})}
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            ...
                            <Text style={{fontFamily: 'rale_light', fontSize: 12, paddingTop: 2}}>Get answers to
                    ...
                    <TouchableOpacity onPress={() => this.setState({showTesting: true})}
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            ...
                            <Text style={{fontFamily: 'rale_light', fontSize: 12, paddingTop: 2}}>View testing centers
                                near you</Text>
                        </View>
                        <View style={{alignSelf: 'center', paddingRight: 15}}>
                            <Ionicons name="ios-arrow-forward" size={30} color="black"/>
                    ...
                    <TouchableOpacity onPress={() => this.setState({showProfile: true})}
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            ...
                            <Text style={{fontFamily: 'rale_light', fontSize: 12, paddingTop: 2}}>View and update your
                    ...
                    <TouchableOpacity onPress={() => this.setState({showStats: true})}
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            ...
                            <Text style={{fontFamily: 'rale_light', fontSize: 12, paddingTop: 2}}>Get the current
                    ...
                    <TouchableOpacity style={{
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            ...
                            <Text style={{fontFamily: 'rale_light', fontSize: 12, paddingTop: 2}}>View our privacy
                                policy</Text>
                        </View>
                        <View style={{alignSelf: 'center', paddingRight: 15}}>
                            <Ionicons name="ios-arrow-forward" size={30} color="black"/>
                    ...
                    <TouchableOpacity style={{
                        ...
                        <View style={{flex: 1, alignSelf: 'center', paddingLeft: 20}}>
                            ...
                            <Text style={{fontFamily: 'rale_light', fontSize: 12, paddingTop: 2}}>Share this app with
                ...
                >
                    ...
                    <View style={styles.modalView}>
                        ...
                        <View style={{marginTop: 40}}>
                            ...
                            <Text style={{fontFamily: 'rale_regular', fontSize: 12, marginTop: 20, marginBottom: 10}}>Enter
                                Age</Text>
                            <TextInput
                ...
                >
                    <View style={styles.modalView}>
                        ...
                        <View>
                            ...
                            {/*Country Picker */}
                            <View style={{marginTop: 20}}>
                                <Text style={{fontFamily: 'rale_bold', fontSize: 12, paddingLeft: 5}}>Select
                                    Country:</Text>
                                <Card style={{
                                    flexDirection: 'row',
