        ...
        return (
            <View style={{flex: 1, backgroundColor: '#fff'}}>
                <View style={{padding: 20}}>
                    <Text style={{fontFamily: 'air_bnb_bold', fontSize: 30}}>Case Reports</Text>
                    <View
                        ...
                        >
                            <Text
                                style={{
                                    ...
                                    color: '#000', fontFamily: 'air_bnb_regular',
                        ...
                        >
                            ...
                            <View style={styles.modalView}>
                                ...
                                <View style={{marginTop: 20}}>
                                    <Text style={{fontFamily: 'air_bnb_regular', fontWeight: 'bold', paddingBottom: 10}}>Who
                                        are you reporting?</Text>
                                    ...
                                    <View>
                                        <Text style={{fontFamily: 'air_bnb_bold', fontWeight: 'bold', paddingBottom: 10}}>Location
                                        ...
                                        <View style={{flexDirection: 'row', paddingTop: 10}}>
                                            <Text style={{fontFamily: 'air_bnb_bold', fontWeight: 'bold', flex: 4}}>Nearest
                                                Landmark</Text>
                                            <Text style={{
