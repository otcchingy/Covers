    ...
    render() {
        ...
        return (
            <View style={{flex: 1, backgroundColor: '#fff'}}>
                <ScrollView style={{flex:.8, paddingBottom: 8}}>
                    <View style={{ flex:1, padding: 16}}>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set1.title}</Text>
                            <Text style={styles.data}>{this.DATA.set1.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set2.title}</Text>
                            <Text style={styles.data}>{this.DATA.set2.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set3.title}</Text>
                            <Text style={styles.data}>{this.DATA.set3.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set4.title}</Text>
                            <Text style={styles.data}>{this.DATA.set4.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set5.title}</Text>
                            <Text style={styles.data}>{this.DATA.set5.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set6.title}</Text>
                            <Text style={styles.data}>{this.DATA.set6.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set7.title}</Text>
                            <Text style={styles.data}>{this.DATA.set7.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set8.title}</Text>
                            <Text style={styles.data}>{this.DATA.set8.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set9.title}</Text>
                            <Text style={styles.data}>{this.DATA.set9.data}</Text>
                        </View>
                        <View style={{paddingBottom: 15}}>
                            <Text style={styles.title}>{this.DATA.set10.title}</Text>
                            <Text style={styles.data}>{this.DATA.set10.data}</Text>
                        </View>
