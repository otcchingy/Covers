            ...
            <Container>
                ...
                <Card style={{marginTop: 30}}>
                    <CardItem header style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                        <Text style={{fontFamily: 'air_bnb_bold', fontSize: 14}}>{value}</Text>
                        <Text style={{fontFamily: 'air_bnb_light', fontSize: 12}}>{date}</Text>
                    </CardItem>
                    <CardItem>
                        <Body>
                        <Text>{data}</Text>
                ...
                >
                    ...
                    <View style={styles.modalView}>
                        ...
                        <View style={{marginTop: 20}}>
                            <Text style={{fontFamily: 'air_bnb_regular', fontWeight: 'bold', marginBottom: 10}}>Who are you
                                reporting?</Text>
                            <View style={{flexDirection: 'row', marginBottom: 30}}>
                                ...
                                <TouchableOpacity onPress={this.onChange}>
                                    <View style={{flexDirection: "row"}}>
                                        ...
                                        <Text style={{fontFamily: 'air_bnb_regular', fontSize: 12, alignSelf: 'center'}}>Other
                                            Individual</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                            <View>
                                <Text style={{fontFamily: 'air_bnb_bold', fontWeight: 'bold', marginBottom: 10}}>Location
                                    or Digital Address</Text>
                                <TextInput
                                ...
                                <View style={{flexDirection: 'row'}}>
                                    ...
                                    <Text style={{fontFamily: 'air_bnb_bold', fontWeight: 'bold', marginBottom: 10}}>Alternate
                                        Contact</Text>
                                </View>
                                <View style={{flexDirection: 'row'}}>
                                    <TextInput
                                ...
                                <Button style={{height: 55, justifyContent: 'center'}}
                                        ...
                                        onPress={
                                            () => {
                                                ...
                                                this.close(!this.state.show);
                                                this.props.navigation.navigate('UpdateReport', {
